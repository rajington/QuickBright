...
- (void)drawInContext:(CGContextRef)context
{
    ...
    if (self.onImage)
    {
        ...
        CGPoint onImagePoint = CGPointMake((textSpaceWidth - onImageSize.width) / 2.0, floorf((self.bounds.size.height - onImageSize.height) / 2.0) + 1.0);
    ...
    if (self.offImage)
    {
        ...
        CGPoint offImagePoint = CGPointMake(textSpaceWidth + (textSpaceWidth - offImageSize.width) / 2.0 + knobRadius, floorf((self.bounds.size.height - offImageSize.height) / 2.0) + 1.0);
